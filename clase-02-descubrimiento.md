...
| **Desconfianza ante réplicas** | Estudiante argentino que busca ropa de marca. | Compra a revendedores de Instagram u otras webs a precios más bajos que las tiendas oficiales. | Los compradores suelen pedir fotos de etiquetas, costuras y otros elementos para comprobar la autenticidad. | Reddit, Facebook, Instagram | **Hecho:** existen comunidades donde se comprueba la autenticidad. **Interpretación:** el miedo a las réplicas puede frenar la compra. | ¿Qué elementos hacen que el comprador confíe en que el producto es original? |
| **Falta de información sobre talles** | Estudiante argentino que compra ropa importada. | Compra prendas de marcas extranjeras sin poder probárselas antes. | Las marcas utilizan diferentes sistemas de tallas y medidas. | Zara, webs de marcas, foros | **Hecho:** existen diferentes sistemas de tallas. **Interpretación:** esto puede generar inseguridad antes de comprar. | ¿Qué información sobre medidas necesita el comprador para decidirse? |
...
| **Miedo a pagar y no recibir el producto** | Estudiante argentino. | Realiza una transferencia o pago antes de encontrarse con el vendedor. | Existen experiencias de usuarios que recomiendan verificar al vendedor antes de pagar. | Reddit, Facebook, redes sociales | **Hecho:** existe preocupación por las estafas online. **Supuesto:** este miedo puede hacer que algunos compradores abandonen la compra. | ¿Qué método de pago genera mayor confianza? ¿El pago contra entrega reduciría el miedo? |
